...
def sortPSMTSV(path : str) -> pd.DataFrame:
...
# overlapping_sequences = df

# for index, i in enumerate(dataframes):
#     overlapping_sequences = pd.merge(overlapping_sequences, i, on="Base Sequence", suffixes = (str(index-1),str(index)))
#     # break
